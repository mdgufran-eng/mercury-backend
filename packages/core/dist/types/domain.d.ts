export type XTMActivity = 'ACTIVE' | 'ARCHIVED' | 'AUTO_ARCHIVED' | 'DELETED' | 'INACTIVE' | 'ACTIVATING' | 'ARCHIVING' | 'AUTO_ARCHIVING' | 'MARKED_FOR_ACTIVATION';
...
export type CallbackEvent = 'project-created' | 'analysis-finished' | 'job-finished' | 'project-completion' | 'source-file-updated' | 'project-activity-changed';
