...
export declare function buildJobFinishedWebhook(callbackUrl: string, projectId: number, jobId: number, customerId: number, translatedContent?: unknown): WebhookRequest;
